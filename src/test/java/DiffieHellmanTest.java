...
//    @Ignore("Remove to run test")
    ...
    public void testPublicKeyCorrectlyCalculated() {
        BigInteger primeA = BigInteger.valueOf(23); //p
        BigInteger primeB = BigInteger.valueOf(5);  //g
        BigInteger privateKey = BigInteger.valueOf(6); // a
        BigInteger expected = BigInteger.valueOf(8); // A
